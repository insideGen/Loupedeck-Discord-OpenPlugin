namespace Loupedeck.DiscordPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.DiscordPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.DiscordPlugin.Resources.Resource.txt`.
